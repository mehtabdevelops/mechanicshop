  ...
  const handleSendNotification = async () => {
    ...
    try {
      const notificationsToInsert = selectedUsers.map(userId => ({
        ...
        expires_at: new Date(Date.now() + notificationForm.expires_in_days * 24 * 60 * 60 * 1000).toISOString()
      }));
      ...
      alert(`Notification sent to ${selectedUsers.length} user(s) successfully!`);
    } catch (error) {
    ...
    return (
      <div style={{ 
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: colors.primary, fontSize: '1.2rem', fontWeight: '600' }}>Loading Notifications...</p>
        </div>
      </div>
    );
  }
              ...
              {notifications.length === 0 ? (
                <div style={{ 
                  ...
                  <svg width="64" height="64" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ color: colors.primary, marginBottom: '1rem', opacity: 0.5 }}>
                    <path d="M10 5a2 2 0 1 1 4 0 7 7 0 0 1 4 6v3a4 4 0 0 0 2 3h-16a4 4 0 0 0 2-3v-3a7 7 0 0 1 4-6z" stroke="currentColor" strokeWidth="2"/>
                    <path d="M9 17v1a3 3 0 0 0 6 0v-1" stroke="currentColor" strokeWidth="2"/>
                  </svg>
                  <h4 style={{ color: colors.primary, marginBottom: '0.5rem' }}>No notifications sent yet</h4>
                    ...
                    <div style={{ 
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ 
                          ...
                          <span>
                            To: <strong>{getUserName(notification.user_id)}</strong>
                          </span>
                          <span>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                ...
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setNotificationForm(prev => ({ ...prev, expires_in_days: parseInt(e.target.value) || 7 }))}
                    min="1"
                    max="30"
                    style={{
                      width: '100%',
