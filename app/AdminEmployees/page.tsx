...
const AdminEmployees = () => {
  ...
  const handleAddEmployee = async () => {
    ...
    if (newEmployee.sin && !isValidSINFormat(newEmployee.sin)) {
      setError('Please enter a valid Social Insurance Number (9 digits) or leave it blank');
      return;
    }
    ...
    return (
      <div style={{ 
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: colors.primary, fontSize: '1.2rem', fontWeight: '600' }}>Loading Employees...</p>
        </div>
      </div>
    );
  }
          ...
          {showAddForm && (
            <div style={{
              ...
              <div style={{ 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', color: colors.text, fontWeight: '600', fontSize: '0.9rem' }}>Social Insurance Number</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', color: colors.text, fontWeight: '600', fontSize: '0.9rem' }}>Department</label>
                  <select 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', color: colors.text, fontWeight: '600', fontSize: '0.9rem' }}>Salary</label>
                  <input 
                    type="number" 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', color: colors.text, fontWeight: '600', fontSize: '0.9rem' }}>Image URL</label>
                  <input 
                    type="text" 
                ...
                <div style={{ gridColumn: '1 / -1' }}>
                  <label style={{ display: 'block', marginBottom: '0.5rem', color: colors.text, fontWeight: '600', fontSize: '0.9rem' }}>Address</label>
                  <textarea 
            ...
            {filteredEmployees.map((employee) => (
              <div key={employee.id} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                  <img 
                    src={employee.image_url || 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&q=80'} 
                    alt={employee.name}
                    style={{
                      width: '60px',
                      height: '60px',
                ...
                <div style={{ marginBottom: '1rem' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.5rem', fontSize: '0.9rem' }}>
                    ...
                    <span style={{ color: colors.textSecondary }}>Hired: {formatDate(employee.hire_date)}</span>
                  </div>
                  {employee.salary && (
                    <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.5rem', fontSize: '0.9rem' }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ color: colors.primary, marginRight: '0.5rem' }}>
                      ...
                      <span style={{ color: colors.textSecondary }}>Salary: ${employee.salary}</span>
                    </div>
                  )}
                  {employee.sin && (
                    <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.5rem', fontSize: '0.9rem' }}>
                      ...
                      <span style={{ color: colors.textSecondary, fontFamily: 'monospace' }}>SIN: {formatSIN(employee.sin)}</span>
                    </div>
                  )}
                </div>
