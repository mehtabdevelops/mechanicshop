          ...
          ScrollTrigger.create({
            ...
            onEnter: () => {
              gsap.from(stat, {
                ...
                onUpdate: function() {
                  const current = parseFloat((this.targets()[0] as HTMLElement).textContent || '0');
                  const suffix = isPercentage ? '%' : (hasPlus ? '+' : '');
                  if (endValue?.includes('/')) {
                    (this.targets()[0] as HTMLElement).textContent = '24/7';
                  } else {
                    (this.targets()[0] as HTMLElement).textContent = current.toFixed(1) + suffix;
                  }
                },
                onComplete: function() {
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
              ...
              <div>
                ...
                <p style={{
                  ...
                  Join Sunny Rewards and earn points towards free services & exclusive perks
                </p>
              </div>
            </div>
            <div style={{
