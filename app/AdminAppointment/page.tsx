...
const AdminAppointments = () => {
  ...
  const fetchAppointments = async () => {
    try {
      ...
      if (error.code === "PGRST301") {
        alert(
          "Error: No appointments table found. Please make sure the table exists in your Supabase database."
        );
      } else if (error.code === "42501") {
        alert(
          "Error: Permission denied. Please check RLS policies for the appointments table."
        );
      } else {
  ...
  const filteredAppointments = appointments.filter(
    (app) => app.preferred_date === selectedDate
  );
  ...
  const handleDeleteAppointment = async (appointmentId: string) => {
    ...
    try {
      ...
      if (error) {
        ...
        if (error.code === "42501") {
          throw new Error(
            "Permission denied. Please check if you have delete permissions for the appointments table."
          );
        } else if (error.code === "23503") {
          throw new Error(
            "Cannot delete appointment due to foreign key constraints."
          );
        } else {
          throw error;
        }
      ...
      if (error.message.includes("Permission denied")) {
        errorMessage +=
          "You do not have permission to delete appointments. Please contact your administrator.";
      } else if (error.message.includes("foreign key")) {
        errorMessage +=
          "This appointment is referenced by other records and cannot be deleted.";
      } else {
  ...
  const handleSaveEdit = async () => {
    if (editFormData) {
      try {
        ...
        setAppointments((prev) =>
          prev.map((app) => (app.id === editFormData.id ? editFormData : app))
        );
      ...
      >
        ...
        >
          ...
          {appointments.length === 0 && (
            ...
            >
              <h3 style={{ color: colors.warning, marginTop: 0 }}>
                No Appointments Found
              </h3>
              <p style={{ color: colors.text, marginBottom: "1rem" }}>
                There are no appointments in the database. This could be
                because:
              </p>
              <ul
                style={{
                    ...
                    <div style={{ marginBottom: "1.5rem" }}>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <path
                              d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18 10h-1.3l-.8-2H12"
                            ...
                            />
                            <path
                              d="M9 19H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h6l2 2h7a2 2 0 0 1 2 2v4.5"
                              stroke={colors.primary}
                              strokeWidth="2"
                            />
                          </svg>
                      ...
                      {appointment.message && (
                        ...
                        >
                          ...
                          >
                            <path
                              d="M14 2H6C5.46957 2 4.96265 2.21071 4.58579 2.58579C4.21071 2.96265 4 3.46957 4 4V20C4 20.5304 4.21071 21.0373 4.58579 21.4142C4.96265 21.7893 5.46957 22 6 22H18C18.5304 22 19.0373 21.7893 19.4142 21.4142C19.7893 21.0373 20 20.5304 20 20V8L14 2Z"
                              stroke={colors.primary}
                              strokeWidth="2"
                            />
                            <path
