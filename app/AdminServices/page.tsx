...
const AdminServices = () => {
  ...
  // Color scheme - Blue accent (#3b82f6) with dark theme
  const colors = {
    primary: '#3b82f6',
    primaryLight: '#60a5fa',
    primaryDark: '#2563eb',
  ...
  const handleAddService = async () => {
    // Basic validation
    if (!newService.name || !newService.category || !newService.description || !newService.price || !newService.duration_minutes || !newService.image_url) {
    ...
    return (
      <div style={{ 
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: colors.primary, fontSize: '1.2rem', fontWeight: '600' }}>Loading Services...</p>
        </div>
      </div>
    );
  }
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            {filteredServices.map(service => (
              ...
              >      
                ...
                >
                  <img 
                    src={service.image_url || 'https://via.placeholder.com/300x180/1f2937/6b7280?text=No+Image'} 
                    alt={service.name}
                    style={{ 
                      width: '100%', 
                      height: '100%', 
                ...
                <div style={{ 
                  ...
                  backgroundColor: service.is_available ? 'rgba(59, 130, 246, 0.2)' : 'rgba(239, 68, 68, 0.2)', 
                ...
                <div style={{ 
                  ...
                  <div>
                    <span style={{ 
                      fontWeight: '700', 
                      color: service.is_available ? colors.success : colors.error,
                      fontSize: '0.9rem'
                    }}>
          ...
          {filteredServices.length === 0 && (
            <div style={{ 
              ...
              <h3 style={{ color: colors.primary, marginBottom: '0.5rem', fontSize: '1.3rem' }}>No services found</h3>
              ...
              <div>
                <label style={{ 
                  ...
                  <input 
                    ...
                    onChange={(e) => setEditingService(prev => prev ? { ...prev, is_available: e.target.checked } : null)}
                    style={{
                      width: '1rem',
                      height: '1rem'
                    }}
              ...
              <div>
                <label style={{ 
                  ...
                  <input 
                    ...
                    onChange={(e) => setNewService(prev => ({ ...prev, is_available: e.target.checked }))}
                    style={{
                      width: '1rem',
                      height: '1rem'
                    }}
